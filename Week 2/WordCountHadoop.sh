...
ls -1
touch WordCount.jar  # you need to create an empty file first otherwise the jar file ends up corrupted
jar cvf WordCount.jar *.class  # note that *.class will match all class files in the current directory
